...
//        criteria.setProjection(Projections.projectionList().add(Property.forName("name")).add(Property.forName("price")));
//        criteria.setResultTransformer(Transformers.aliasToBean(Item.class));
