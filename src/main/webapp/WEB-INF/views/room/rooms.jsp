            ...
            <div class="content-panel">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-primary btn-xs"><a href="edit_room?id=${room.id}">Edit</a></button>
                            <button class="btn btn-danger btn-xs"><a href="delete?id=${room.id}">Delete</a></button>
                        </td>
                    </tr>
                    </c:forEach>
                    </tbody>
